...
using DAL;
using NoNameApp.ViewModels;
using AutoMapper;
using Microsoft.Extensions.Logging;
using NoNameApp.Helpers;

namespace NoNameApp.Controllers {
    ...
    public class CustomerController : ControllerBase {
        ...
        public async Task<string> Email() {
            ...
            (bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from NoNameApp", message);
