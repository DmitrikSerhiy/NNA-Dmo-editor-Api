...
public sealed class CharactersRepository : ICharactersRepository {
    ...
    public async Task<bool> IsExist(string characterName, Guid dmoId, CancellationToken cancellationToken) {
    ...
    public async Task<NnaMovieCharacter?> GetCharacterById(Guid characterId, CancellationToken cancellationToken) {
