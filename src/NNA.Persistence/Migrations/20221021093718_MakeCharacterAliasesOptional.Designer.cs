...
namespace Persistence.Migrations
{
    ...
    [Migration("20221021093718_MakeCharacterAliasesOptional")]
    partial class MakeCharacterAliasesOptional
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeatNnaMovieCharacter", b =>
                {
                    ...
                    b.ToTable("NnaCharactersBeats", (string)null);
                });
            ...
            modelBuilder.Entity("BeatNnaMovieCharacter", b =>
                {
                    b.HasOne("NNA.Domain.Entities.Beat", null)
                        .WithMany()
                        .HasForeignKey("BeatsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NNA.Domain.Entities.NnaMovieCharacter", null)
                        .WithMany()
